...
def download_feature_quads() -> None:
    ...
    for idx_blob, quad_blob in enumerate(quad_blobs):
        print('\rDownloading blob {} of {}'.format(1+idx_blob, len(quad_blobs)), end='')
        data_bucket.download_model_training_input_data_for_quad_blob(DIR_TRAINING_DATA, quad_blob)
